...
const SelectBetting: FC<Props> = ({ visible, onClose, onConfirm }) => {
  const [selected, setSelected] = useState(0);

  const goToGame = () => onConfirm(selected)

  return (
    <Dialog title="选择投注界面" visible={visible} onAnimationend={close}>
      <SelectBox
      ...
      <Row
        ...
        ailgn="center"
      >
        <MyButton cancel name="取消" width={140} onClick={onClose} />
        <MyButton
